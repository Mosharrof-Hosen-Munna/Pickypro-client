...
const Blog = () => {
    ...
    return (
        <div className='bg-slate-100 py-14'>
            <div className='container mx-auto bg-white  shadow-xl rounded-lg p-9'>
                <header>
                    <h1 className='text-5xl text-center mb-5 font-semibold'>Blog</h1>
                </header>
                <section>
                    <h1 className='text-4xl mb-4 font-semibold'>Difference between SQL and NoSQL?</h1>
                ...
                <section>
                    <h1 className='text-4xl mb-4 font-semibold'>What is JWT, and how does it work??</h1>
                    <div className='text-2xl'>
                ...
                <section>
                    <h1 className='text-4xl mb-4 font-semibold'>What is the difference between javascript and NodeJS?</h1>
                    <div className='text-2xl'>
                ...
                <section>
                    <h1 className='text-4xl mb-4 font-semibold'>How does NodeJS handle multiple requests at the same time?</h1>
                    <div className='text-2xl'>
